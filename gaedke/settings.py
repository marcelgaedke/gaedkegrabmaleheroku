"""
Django settings for gaedke project.
...
import os
from gaedke.settings_private import *
...
INSTALLED_APPS = [
    'grabmale_de.apps.GrabmaleDeConfig',
...
WSGI_APPLICATION = 'gaedke.wsgi.application'
