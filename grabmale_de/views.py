...
#     output= Category.objects.all()
#     return HttpResponse(output)


class IndexView(generic.ListView):
    model=Category
    template_name = 'grabmale_de/index.html'
...
class DetailView(generic.DetailView):
    model = Category
    template_name = 'grabmale_de/category.html'
    ...
    def get_context_data(self, **kwargs):
        ...
        path2 = "pictures/" + cat.category_name + "/"
...
class ImpressumView(generic.ListView):
    model = Category
    template_name = 'grabmale_de/impressum.html'